$(function () {
    ...
    var carpeta = nivel === "primaria" ? "cursos-primaria" : "cursos-secundaria";

    $.getJSON("data/" + carpeta + "/" + area + ".json", function (datos) {
        var nivelTexto = nivel === "primaria" ? "Primaria" : "Secundaria";
